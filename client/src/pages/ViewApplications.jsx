          ...
          <tbody>
            {
              viewApplicationsPageData.map((applicant,index) => (
                <tr key={index} className='text-gray-700'>
                  ...
                  <td className='py-2 px-4 border-b flex items-center gap-2 text-center'><img className='w-10 h-10 rounded-full mr-3 max-sm:hidden' src={applicant.imgSrc} alt="" />
                  ...
                  <td className='py-2 px-4 border-b'>
                    <a className='bg-blue-50 text-blue-400 px-3 py-1 inline-flex gap-2 items-center rounded' href="" target='_blank'><img src={assets.resume} alt="" />Resume <img src={assets.resume_download_icon} alt="" /></a>
                  </td>
